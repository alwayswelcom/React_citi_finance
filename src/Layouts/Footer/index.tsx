const Footer = () => {
    return (
        <div className="px-24 pt-24 pb-10 bg-darkblue text-white">
            <div className="flex items-center justify-between children:min-w-1/4 children:h-80 children:text-left flex-wrap children: pb-35">
                <div className="">
